...
EXE_PC = control_pc
SOURCE_FILES_PC = control.cpp pid.cpp io.cpp ahrs.c crc_xmodem_generic.c io_ahrs_pc.c io_pc.cpp io_depth_pc.cpp io_m5_pc.c m5.c crc32.c
...
SOURCE_FILES_ARD = control.cpp pid.cpp io.cpp ahrs.c crc_xmodem_generic.c io_ahrs_avr.c io_arduino.cpp io_depth_arduino.cpp io_kill_arduino.cpp io_m5_avr.c m5.c crc32.c
